...
public class Movie {
    /**
     * The unique identifier for the movie. Must be greater than 0 and generated automatically.
     */
    ...
    /**
     * The date and time when the movie was created. Cannot be null and generated automatically.
     */
    private ZonedDateTime creationDate;

    /**
     * The number of Oscars won by the movie. Must be greater than 0 and can be null.
     */
    private Integer oscarsCount;

    /**
     * The number of Golden Palms won by the movie. Must be greater than 0 and cannot be null.
     */
