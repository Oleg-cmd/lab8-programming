...
/**
 * RemoveLowerCommand is a class that represents the remove_lower command. It
 * removes the last movie in the collection
...
public class RemoveLowerCommand implements Command {
        ...
        try {
            ...
            try {
                ...
                if (last.ordinal() <= movieRating.ordinal()) {
                    ...
                    output.append("The movie was removed");
                } else {
    ...
    /**
     * Executes the remove_lower command. Prompts the user to enter an MPAA rating
     * and removes the last movie in the
     * collection that has a rating lower than or equal to the one entered by the
     * user.
     */
